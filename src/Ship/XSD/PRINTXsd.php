...
class PRINTXsd
{
    ...
    /**
     * @property \TNTExpressConnect\Ship\XSD\ERROR[] $cONNOTE
     */
    private $cONNOTE = null;

    /**
     * @property \TNTExpressConnect\Ship\XSD\ERROR[] $lABEL
     */
    private $lABEL = null;

    /**
     * @property \TNTExpressConnect\Ship\XSD\ERROR[] $mANIFEST
     */
    private $mANIFEST = null;

    /**
     * @property \TNTExpressConnect\Ship\XSD\ERROR[] $iNVOICE
     */
     ...
     * @param \TNTExpressConnect\Ship\XSD\ERROR $eRROR
     */
    public function addToCONNOTE(\TNTExpressConnect\Ship\XSD\ERROR $eRROR)
    {
        $this->cONNOTE[] = $eRROR;
        return $this;
    }
     ...
     * Sets a new cONNOTE
     *
     * @param \TNTExpressConnect\Ship\XSD\ERROR[] $cONNOTE
     * @return self
     */
     ...
     * @param \TNTExpressConnect\Ship\XSD\ERROR $eRROR
     */
    public function addToLABEL(\TNTExpressConnect\Ship\XSD\ERROR $eRROR)
    {
        $this->lABEL[] = $eRROR;
        return $this;
    }
     ...
     * Sets a new lABEL
     *
     * @param \TNTExpressConnect\Ship\XSD\ERROR[] $lABEL
     * @return self
     */
     ...
     * @param \TNTExpressConnect\Ship\XSD\ERROR $eRROR
     */
    public function addToMANIFEST(\TNTExpressConnect\Ship\XSD\ERROR $eRROR)
    {
        $this->mANIFEST[] = $eRROR;
        return $this;
    }
     ...
     * Sets a new mANIFEST
     *
     * @param \TNTExpressConnect\Ship\XSD\ERROR[] $mANIFEST
     * @return self
     */
     ...
     * @param \TNTExpressConnect\Ship\XSD\ERROR $eRROR
     */
    public function addToINVOICE(\TNTExpressConnect\Ship\XSD\ERROR $eRROR)
    {
        $this->iNVOICE[] = $eRROR;
        return $this;
    }
     ...
     * Sets a new iNVOICE
     *
     * @param \TNTExpressConnect\Ship\XSD\ERROR[] $iNVOICE
     * @return self
     */
